...
public class UIBattleTipInfo : IClone<UIBattleTipInfo>
{
    ...
    {
        return new UIBattleTipInfo(HitMCB_GUID, BattleTipType, AttackerType, DiffHP, ElementHP, Scale, ElementType, SpriteImagePath, StartPos, Offset, RandomRange, DisappearTime);
    }
}