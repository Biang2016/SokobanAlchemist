...
public class InGameHealthBar : PoolObject
{
    ...
    void Update()
    {
        ...
        {
            Vector2 screenPos = CameraManager.Instance.MainCamera.WorldToScreenPoint(ActorBattleHelper.HealthBarPivot.position + ActorBattleHelper.Actor.EntityGeometryCenter - ActorBattleHelper.Actor.transform.position);
