...
public class EntitySkillCondition_State : EntitySkillCondition, EntitySkillCondition.IPureCondition
{
    ...
    private bool CheckPerTick()
    {
        switch (m_ConditionType)
        {
            ...
            {
                return BattleManager.Instance.GetStateBool(BattleStateBool.FormatEventAliasOrStateBool(Entity.CurrentEntityData.InitWorldModuleGUID, Entity.CurrentEntityData.InitStaticLayoutGUID)) == BattleStateBoolValue;
            }
        }
